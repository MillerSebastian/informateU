  ...
  >
    <div class="news-card__media">
      <div v-if="news.fileType === 'image'" class="news-card__image-container">
        <img :src="news.mediaUrl" alt="Imagen de la noticia" class="news-card__image" />
      </div>
      <div v-else-if="news.fileType === 'video'" class="news-card__video-container">
    ...
    <div class="news-card__content">
      ...
      <div class="news-card__author">
        ...
        <div class="news-card__author-info">
          <span class="news-card__author-name">@{{ truncateText(news.author, 20) }}</span>
          <time class="news-card__date" :datetime="news.timestamp">{{ formattedDate }}</time>
        </div>
      </div>

      <div class="news-card__description">
        <p :class="{ 'news-card__description--clipped': !isExpanded }">{{ news.description }}</p>
        <button v-if="isDescriptionLong" class="news-card__toggle-btn" @click="isExpanded = !isExpanded">
